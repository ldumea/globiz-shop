...
class PHPExcel_Reader_Excel5_Escher
{
	...
	public function load($data)
	{
		...
		while ($this->_pos < $this->_dataSize) {
			...
			$fbt = Excel5_reader::_GetInt2d($this->_data, $this->_pos + 2);
	...
	private function _readDefault()
	{
		...
		$verInstance = Excel5_reader::_GetInt2d($this->_data, $this->_pos);
		...
		$length = Excel5_reader::_GetInt4d($this->_data, $this->_pos + 4);
	...
	private function _readBSE()
	{
		...
		$recInstance = (0xFFF0 & Excel5_reader::_GetInt2d($this->_data, $this->_pos)) >> 4;
		...
		$tag = Excel5_reader::_GetInt2d($recordData, 18);

		// offset: 20; size: 4; size of BLIP in bytes
		$size = Excel5_reader::_GetInt4d($recordData, 20);

		// offset: 24; size: 4; number of references to this BLIP
		$cRef = Excel5_reader::_GetInt4d($recordData, 24);

		// offset: 28; size: 4; MSOFO file offset
		$foDelay = Excel5_reader::_GetInt4d($recordData, 28);
	...
	private function _readClientAnchor()
	{
		...
		$c1 = Excel5_reader::_GetInt2d($recordData, 2);

		// offset: 4; size: 2; upper-left corner horizontal offset in 1/1024 of column width
		$startOffsetX = Excel5_reader::_GetInt2d($recordData, 4);

		// offset: 6; size: 2; upper-left corner row index (0-based)
		$r1 = Excel5_reader::_GetInt2d($recordData, 6);

		// offset: 8; size: 2; upper-left corner vertical offset in 1/256 of row height
		$startOffsetY = Excel5_reader::_GetInt2d($recordData, 8);

		// offset: 10; size: 2; bottom-right corner column index (0-based)
		$c2 = Excel5_reader::_GetInt2d($recordData, 10);

		// offset: 12; size: 2; bottom-right corner horizontal offset in 1/1024 of column width
		$endOffsetX = Excel5_reader::_GetInt2d($recordData, 12);

		// offset: 14; size: 2; bottom-right corner row index (0-based)
		$r2 = Excel5_reader::_GetInt2d($recordData, 14);

		// offset: 16; size: 2; bottom-right corner vertical offset in 1/256 of row height
		$endOffsetY = Excel5_reader::_GetInt2d($recordData, 16);
	...
	private function _readOfficeArtRGFOPTE($data, $n) {
		...
		for ($i = 0; $i < $n; ++$i) {
			...
			$opid = Excel5_reader::_GetInt2d($fopte, 0);
			...
			$op = Excel5_reader::_GetInt4d($fopte, 2);

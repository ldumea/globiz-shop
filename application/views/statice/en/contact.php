			...
			<div class="col content statice" id="content">
				<div class="row">
					...
					<div class="col-md-6 text-left">
						...
						<div class="section-title text-uppercase"><span>Contact form</span></div>
						...
						<form id="contact-form" name="contact-form" action="javascript:;" onsubmit="return false;" method="post">
							...
							<div class="outer required">
								<div class="form-group">
									<input type="button" class="btn btn-dark px-5 text-uppercase fs20 d-inline-block" id="submit_btn" value="Send" onclick="sendContact()" />
								</div>
							</div>
